...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary shadow-sm">
    ...
    <div class="container my-5">
        <div class="card shadow-lg p-3 p-md-5">
            ...
            <form class="row g-3" action="/edit_trade_licence/{{ $licence->id  }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control @error('fiscal_year') is-invalid @enderror" id="fiscal_year" name="fiscal_year" placeholder="e.g., 2024-2025" value="{{ old('fiscal_year', $licence->fiscal_year ?? '') }}">
                    @error('fiscal_year')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-6">
                    <img src="{{ $licence->applicant_image }}" alt="No image uploded" width="200" height="200">
                </div>
