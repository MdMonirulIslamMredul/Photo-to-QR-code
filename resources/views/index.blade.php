...
<div class="container mt-5">
    ...
    @auth
        ...
        <div class="mb-3">
            <input type="text" id="searchInput" class="form-control" placeholder="🔍 Search by Applicant Name, Email, or Licence No...">
        </div>
        ...
        <div class="card shadow-lg">
                            ...
                            @forelse ($licences as $licence)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="{{ url('/trade_licence/' . $licence->email) }}" class="btn btn-info btn-sm me-2" title="View Details">
         ...
         <a href="{{ route('gallery.index') }}" class="btn btn-warning btn-sm w-50" style="font-weight: bold; color: #000;">
            <i class="fas fa-arrow-left me-2" style="font-size: 1.2em;"></i>Go to Gallery
        </a>
    ...
    @guest
        <div class="text-center py-5">
            <h1 class="display-5"> For Home Access </h1>
            <p class="lead mt-3">
                Please log in to your account to view and manage.
            </p>
...
<script>
    document.getElementById('searchInput').addEventListener('keyup', function() {
        ...
        tableRows.forEach(row => {
            // Get text from all cells in the row (name, email, licence no)
            const rowText = row.textContent.toLowerCase();

            // Show row if it contains the search term, otherwise hide it
